...
# You should see an o with two dots over it here [Ã¶]
# You should see a micro (u with a tail) here [Âµ]
# You should see a trademark symbol here [â„¢]
...
#   Copyright (C) 2010 Rico SchÃ¼ller
...
#   Copyright (C) 2011 Åukasz WojniÅ‚owicz
...
w_read_key()
{
    ...
    then
        # read key from user
        case $LANG in
        da*) _W_keymsg="Angiv venligst registrerings-nÃ¸glen for pakken '$_PACKAGE'"
            _W_nokeymsg="Ingen nÃ¸gle angivet"
            ;;
        de*) _W_keymsg="Bitte einen Key fÃ¼r Pakete '$W_PACKAGE' eingeben"
            _W_nokeymsg="Keinen Key eingegeben?"
            ;;
        pl*) _W_keymsg="ProszÄ™ podaÄ‡ klucz dla programu '$W_PACKAGE'"
            _W_nokeymsg="Nie podano klucza"
            ;;
        uk*) _W_keymsg="Ð‘ÑƒÐ´ÑŒ Ð»Ð°ÑÐºÐ°, Ð²Ð²ÐµÐ´Ñ–Ñ‚ÑŒ ÐºÐ»ÑŽÑ‡ Ð´Ð»Ñ Ð´Ð¾Ð´Ð°Ñ‚ÐºÐ° '$W_PACKAGE'"
            _W_nokeymsg="ÐšÐ»ÑŽÑ‡ Ð½Ðµ Ð½Ð°Ð´Ð°Ð½Ð¾"
            ;;
...
w_download_manual_to()
{
    ...
    case $LANG in
    da*) _W_dlmsg="Hent venligst filen $_W_file fra $_W_url og placÃ©r den i $W_CACHE/$_W_packagename, kÃ¸r derefter dette skript.";;
    ...
    pl*) _W_dlmsg="ProszÄ™ pobraÄ‡ plik $_W_file z $_W_url, nastÄ™pnie umieÅ›ciÄ‡ go w $W_CACHE/$_W_packagename, a na koÅ„cu uruchomiÄ‡ ponownie ten skrytp.";;
    uk*) _W_dlmsg="Ð‘ÑƒÐ´ÑŒ Ð»Ð°ÑÐºÐ°, Ð·Ð²Ð°Ð½Ñ‚Ð°Ð¶Ñ‚Ðµ $_W_file Ð· $_W_url, Ñ€Ð¾Ð·Ñ‚Ð°ÑˆÑƒÐ¹Ñ‚Ðµ Ð² $W_CACHE/$_W_packagename, Ð¿Ð¾Ñ‚Ñ–Ð¼ Ð·Ð°Ð¿ÑƒÑÑ‚Ñ–Ñ‚ÑŒ ÑÐºÑ€Ð¸Ð¿Ñ‚ Ð·Ð½Ð¾Ð²Ñƒ.";;
...
w_workaround_wine_bug()
{
    ...
    *)  _W_msg="-- $2";;
    ...
    pl*) w_warn "Obchodzenie bÅ‚Ä™du w wine ${1} $_W_msg" ;;
    uk*) w_warn "ÐžÐ±Ñ…Ñ–Ð´ Ð¿Ð¾Ð¼Ð¸Ð»ÐºÐ¸ ${1} $_W_msg" ;;
...
{
    case $LANG in
    uk*) _W_msg_title="Winetricks - Ð²Ð¸Ð±ÐµÑ€Ñ–Ñ‚ÑŒ wineprefix"
         _W_msg_body='Ð©Ð¾ Ð’Ð¸ Ñ…Ð¾Ñ‡ÐµÑ‚Ðµ Ð·Ñ€Ð¾Ð±Ð¸Ñ‚Ð¸?'
         _W_msg_apps='Ð’ÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚Ð¸ Ð´Ð¾Ð´Ð°Ñ‚Ð¾Ðº'
         _W_msg_games='Ð’ÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚Ð¸ Ð³Ñ€Ñƒ'
         _W_msg_benchmarks='Ð’ÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚Ð¸ benchmark'
         _W_msg_default="Ð’Ð¸Ð±Ñ€Ð°Ñ‚Ð¸ wineprefix Ð·Ð° Ð·Ð°Ð¼Ð¾Ð²Ñ‡ÑƒÐ²Ð°Ð½Ð½ÑÐ¼"
         _W_msg_unattended0="Ð’Ð¸Ð¼ÐºÐ½ÑƒÑ‚Ð¸ Ð°Ð²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ñ‡Ð½Ñƒ ÑƒÑÑ‚Ð°Ð½Ð¾Ð²ÐºÑƒ"
         _W_msg_unattended1="Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚Ð¸ Ð°Ð²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ñ‡Ð½Ñƒ ÑƒÑÑ‚Ð°Ð½Ð¾Ð²ÐºÑƒ"
         _W_msg_showbroken0="Ð¡Ñ…Ð¾Ð²Ð°Ñ‚Ð¸ Ð½ÐµÑÑ‚Ð°Ð±Ñ–Ð»ÑŒÐ½Ñ– Ð´Ð¾Ð´Ð°Ñ‚ÐºÐ¸ (Ð½Ð°Ð¿Ñ€Ð¸ÐºÐ»Ð°Ð´ Ð· Ð¿Ñ€Ð¾Ð±Ð»ÐµÐ¼Ð°Ð¼Ð¸ Ð· DRM)"
         _W_msg_showbroken1="ÐŸÐ¾ÐºÐ°Ð·Ð°Ñ‚Ð¸ Ð½ÐµÑÑ‚Ð°Ð±Ñ–Ð»ÑŒÐ½Ñ– Ð´Ð¾Ð´Ð°Ñ‚ÐºÐ¸ (Ð½Ð°Ð¿Ñ€Ð¸ÐºÐ»Ð°Ð´ Ð· Ð¿Ñ€Ð¾Ð±Ð»ÐµÐ¼Ð°Ð¼Ð¸ Ð· DRM)"
         _W_msg_help="ÐŸÐµÑ€ÐµÐ³Ð»ÑÐ½ÑƒÑ‚Ð¸ Ð´Ð¾Ð²Ñ–Ð´ÐºÑƒ"
         ;;
...
{
    case $LANG in
    da*) _W_msg_title='VÃ¦lg en pakke-kategori'
         _W_msg_body='Hvad Ã¸nsker du at gÃ¸re?'
         ...
         ;;
    de*) _W_msg_title='Pakettyp auswÃ¤hlen'
         _W_msg_body='Was mÃ¶chten Sie tun?'
    ...
    pl*) _W_msg_title="Winetricks - obecny prefiks to \"$WINEPREFIX\""
         ...
         _W_msg_dlls="Zainstaluj WindowsowÄ… bibliotekÄ™ DLL lub komponent"
         _W_msg_fonts='Zainstaluj czcionkÄ™'
         _W_msg_settings='ZmieÅ„ ustawienia'
         _W_msg_winecfg='Uruchom winecfg'
         _W_msg_regedit='Uruchom regedit'
         _W_msg_taskmgr='Uruchom taskmgr'
         _W_msg_shell='Uruchom powÅ‚okÄ™ wiersza poleceÅ„ (dla debugowania)'
         _W_msg_folder='PrzeglÄ…daj pliki'
         _W_msg_annihilate="UsuÅ„ WSZYSTKIE DANE I APLIKACJE WEWNÄ„TRZ TEGO WINEPREFIXA"
         ;;
    uk*) _W_msg_title="Winetricks - Ð¿Ð¾Ñ‚Ð¾Ñ‡Ð½Ð¸Ð¹ prefix \"$WINEPREFIX\""
         _W_msg_body='Ð©Ð¾ Ð’Ð¸ Ñ…Ð¾Ñ‡ÐµÑ‚Ðµ Ð·Ñ€Ð¾Ð±Ð¸Ñ‚Ð¸ Ð´Ð»Ñ Ñ†ÑŒÐ¾Ð³Ð¾ wineprefix?'
         _W_msg_dlls="Ð’ÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚Ð¸ Windows DLL Ñ‡Ð¸ ÐºÐ¾Ð¼Ð¿Ð¾Ð½ÐµÐ½Ñ‚(Ð¸)"
         _W_msg_fonts='Ð’ÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚Ð¸ ÑˆÑ€Ð¸Ñ„Ñ‚'
         _W_msg_settings='Ð—Ð¼Ñ–Ð½Ð¸Ñ‚Ð¸ Ð½Ð°Ð»Ð°ÑˆÑ‚ÑƒÐ²Ð°Ð½Ð½Ñ'
         _W_msg_winecfg='Ð—Ð°Ð¿ÑƒÑÑ‚Ð¸Ñ‚Ð¸ winecfg'
         _W_msg_regedit='Ð—Ð°Ð¿ÑƒÑÑ‚Ð¸Ñ‚Ð¸ regedit'
         _W_msg_taskmgr='Ð—Ð°Ð¿ÑƒÑÑ‚Ð¸Ñ‚Ð¸ taskmgr'
         _W_msg_shell='Ð—Ð°Ð¿ÑƒÑÐº ÐºÐ¾Ð¼Ð°Ð½Ð´Ð½Ð¾Ñ— Ð¾Ð±Ð¾Ð»Ð¾Ð½ÐºÐ¸ (Ð´Ð»Ñ Ð½Ð°Ð»Ð°Ð³Ð¾Ð´Ð¶ÐµÐ½Ð½Ñ)'
         _W_msg_folder='ÐŸÐµÑ€ÐµÐ³Ð»ÑÐ´ Ñ„Ð°Ð¹Ð»Ñ–Ð²'
         _W_msg_annihilate="Ð’Ð¸Ð´Ð°Ð»Ð¸Ñ‚Ð¸ Ð£Ð¡Ð† Ð”ÐÐÐ† Ð¢Ð ÐŸÐ ÐžÐ“Ð ÐÐœÐ˜ Ð— Ð¦Ð¬ÐžÐ“Ðž WINEPREFIX"
         ;;
...
winetricks_settings_menu()
{
    ...
    case $LANG in
    da*) _W_msg_title='VÃ¦lg en pakke'
         _W_msg_body='Which settings would you like to change?'
         ;;
    de*) _W_msg_title='Pakete auswÃ¤hlen'
         _W_msg_body='Which settings would you like to change?'
         ;;
    pl*) _W_msg_title="Winetricks - obecny prefiks to \"$WINEPREFIX\""
         _W_msg_body='Which settings would you like to change?'
         ;;
    uk*) _W_msg_title="Winetricks - Ð¿Ð¾Ñ‚Ð¾Ñ‡Ð½Ð¸Ð¹ prefix \"$WINEPREFIX\""
         _W_msg_body='Ð¯ÐºÑ– Ð½Ð°Ð»Ð°ÑˆÑ‚ÑƒÐ²Ð°Ð½Ð½Ñ Ð’Ð¸ Ñ…Ð¾Ñ‡ÐµÑ‚Ðµ Ð·Ð¼Ñ–Ð½Ð¸Ñ‚Ð¸?'
         ;;
    *)   _W_msg_title="Winetricks - current prefix is \"$WINEPREFIX\""
         _W_msg_body='Which settings would you like to change?'
         ;;
...
winetricks_showmenu()
{
    ...
    da*) _W_msg_title='VÃ¦lg en pakke'
         ...
         ;;
    de*) _W_msg_title='Pakete auswÃ¤hlen'
         _W_msg_body='Welche Pakete mÃ¶chten Sie installieren?'
         _W_cached="gecached"
         ;;
    pl*) _W_msg_title="Winetricks - obecny prefiks to \"$WINEPREFIX\""
         _W_msg_body='KtÃ³re paczki chesz zainstalowaÄ‡?'
         _W_cached="zarchiwizowane"
         ;;
    uk*) _W_msg_title="Winetricks - Ð¿Ð¾Ñ‚Ð¾Ñ‡Ð½Ð¸Ð¹ prefix \"$WINEPREFIX\""
         _W_msg_body='Ð¯ÐºÑ– Ð¿Ð°ÐºÑƒÐ½ÐºÐ¸ Ð’Ð¸ Ñ…Ð¾Ñ‡ÐµÑ‚Ðµ Ð²ÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚Ð¸?'
         _W_cached="ÐºÐµÑˆÐ¾Ð²Ð°Ð½Ð¾"
         ;;
    *)   _W_msg_title="Winetricks - current prefix is \"$WINEPREFIX\""
    ...
    zenity)
        ...
        uk*) printf %s "zenity \
                ...
                --checklist \
                --column '' \
                --column ÐŸÐ°ÐºÑƒÐ½Ð¾Ðº \
                --column ÐÐ°Ð·Ð²Ð° \
                --column Ð’Ð¸Ð´Ð°Ð²ÐµÑ†ÑŒ \
                --column Ð Ñ–Ðº \
                --column ÐœÐµÐ´Ñ–Ð° \
                --column Ð¡Ñ‚Ð°Ñ‚ÑƒÑ \
                --column 'Ð Ð¾Ð·Ð¼Ñ–Ñ€ (ÐœÐ‘)' \
                --column 'Ð§Ð°Ñ (ÑÐµÐº)' \
                --height $WINETRICKS_MENU_HEIGHT \
                --width $WINETRICKS_MENU_WIDTH \
                "
...
winetricks_list_all()
{
    ...
    uk*) _W_cached="ÐºÐµÑˆÐ¾Ð²Ð°Ð½Ð¾"   ; _W_download="Ð·Ð°Ð²Ð°Ð½Ñ‚Ð°Ð¶ÑƒÐ²Ð°Ð½Ðµ"  ;;
...
winetricks_cache_iso()
{
    ...
    do
        ...
        then
            case $LANG in
            da*)  w_warn "Forkert disk [$_W_volname] indsat. IndsÃ¦t venligst disken [$_W_expected_volname]" ;;
            de*)  w_warn "Falsche Disk [$_W_volname] eingelegt.  Bitte legen Sie Disk [$_W_expected_volname] ein!" ;;
        pl*)  w_warn "WÅ‚oÅ¼ono zÅ‚y dysk [$_W_volname].  ProszÄ™ wÅ‚oÅ¼yÄ‡ dysk [$_W_expected_volname]" ;;
            uk*)  w_warn "ÐÐµÐ¿Ñ€Ð°Ð²Ð¸Ð»ÑŒÐ½Ð¸Ð¹ Ð´Ð¸ÑÐº [$_W_volname].  Ð‘ÑƒÐ´ÑŒ Ð»Ð°ÑÐºÐ°, Ð²ÑÑ‚Ð°Ð²Ñ‚Ðµ Ð´Ð¸ÑÐº [$_W_expected_volname]" ;;
...
winetricks_mount_real_volume()
{
    ...
    case $LANG in
    da*)_W_mountmsg="IndsÃ¦t venligst disken '$_W_expected_volname' (krÃ¦vet af pakken '$_PACKAGE')" ;;
    de*)_W_mountmsg="Disc '$_W_expected_volname' bitte einlegen (fÃ¼r Pakete '$W_PACKAGE')" ;;
    pl*)  _W_mountmsg="ProszÄ™ wÅ‚oÅ¼yÄ‡ dysk '$_W_expected_volname' (potrzebny paczce '$W_PACKAGE')" ;;
    uk*)  _W_mountmsg="Ð‘ÑƒÐ´ÑŒ Ð»Ð°ÑÐºÐ°, Ð²ÑÑ‚Ð°Ð²Ñ‚Ðµ Ñ‚Ð¾Ð¼ '$_W_expected_volname' (Ð¿Ð¾Ñ‚Ñ€Ñ–Ð±Ð½Ð¸Ð¹ Ð´Ð»Ñ Ð¿Ð°ÐºÑƒÐ½ÐºÐ° '$W_PACKAGE')" ;;
...
winetricks_set_wineprefix()
{
    ...
    "")  w_die "$WINE cmd.exe /c echo '%ProgramFiles%' returned empty string, error message '`cat /tmp/early_wine.err.txt`'";;
...
KÃ¸rer de angivne verber.  Hvert verbum installerer et program eller Ã¦ndrer en indstilling.
Tilvalg:
-k|--keep_isos: lagr iso'er lokalt (muliggÃ¸r senere installation uden disk)
-q|--unattended: stil ingen spÃ¸rgsmÃ¥l, installÃ©r bare automatisk
-r|--ddrescue: brug alternativ disk-tilgangsmetode (hjÃ¦lper i tilfÃ¦lde af en ridset disk)
-v|--verbose: vis alle kommandoer som de bliver udfÃ¸rt
...
Angegebene Verben ausfÃ¼hren.
Jeder Verb installiert z.B. eine Anwendung oder Ã¤ndert eine Einstellung.
Optionen:
-k|--keep_isos: isos local speichern (erlaubt spÃ¤tere Installierung ohne Disk)
...
-v|--verbose: alle ausgefÃ¼hrten Kommandos anzeigen
-V|--version: Programmversion anzeigen
-h|--help: diese Hilfemeldung anzeigen
Verben:
apps: Typ 'Andwendungen' auswÃ¤hlen
games: Typ 'Spiele' auswÃ¤hlen
list: Verben von ausgewÃ¤hlte Typ auflisten
list-cached: Verben fÃ¼r schon gecachte Installers auflisten
list-download: Verben fÃ¼r herunterladbare Anwendungen auflisten
list-manual-download: list applications which can be downloaded with some help from the user
list-installed: Verben fÃ¼r schon installlierte Programme auflisten
_EOF_
        ;;
    *)
        cat <<_EOF_
...
winetricks_install_app()
{
    ...
    uk*) fail_msg="ÐŸÐ¾Ð¼Ð¸Ð»ÐºÐ° Ð²ÑÑ‚Ð°Ð½Ð¾Ð²Ð»ÐµÐ½Ð½Ñ Ð¿Ð°ÐºÑƒÐ½ÐºÐ° $1" ;;
...
load_gdiplus_winxp()
{
    ...
    cd "$W_CACHE"/gdiplus
    w_try_cabextract -d "$W_TMP" -F FL_gdiplus_dll_____X86.3643236F_FC70_11D3_A536_0090278A1BB8 "$W_CACHE"/gdiplus_winxp/$file1
...
w_metadata remove_mono settings \
    title_uk="Ð’Ð¸Ð´Ð°Ð»Ð¸Ñ‚Ð¸ Ð²Ð±ÑƒÐ´Ð¾Ð²Ð°Ð½Ðµ wine-mono" \
...
load_7zip()
{
    w_download http://downloads.sourceforge.net/project/sevenzip/7-Zip/9.20/7z920.exe 55283ad59439134673fc32fc097bdd9ae920fbc6
    cd "$W_CACHE/$W_PACKAGE"
    w_try "$WINE" 7z920.exe $W_UNATTENDED_SLASH_S
...
load_steam()
{
    ...
    w_try "$WINE" SteamSetup.exe $W_UNATTENDED_SLASH_Q
...
load_uplay()
{
    ...
    if w_workaround_wine_bug 33742 "Using native crypt32 so uplay's autoupdater doesn't abort"
    then
    ...
    w_declare_exe "$W_PROGRAMS_X86_WIN\\Ubisoft\\Ubisoft Game Launcher" "Uplay.exe"
}

#----------------------------------------------------------------

w_metadata utorrent apps \
    title="ÂµTorrent 2.2.1" \
...
load_utorrent3()
{
    ...
    cd "$W_CACHE/$W_PACKAGE"
    # If you don't use /PERFORMINSTALL, it just runs uTorrent
...
load_vc2005trial()
{
    ...
    if w_workaround_wine_bug 27987 "Install fails with error about CA_RollbackHelpTransaction" ,1.3.19 1.3.37,
    then
        w_die "Please upgrade to wine-1.3.37 or later to install this app"
    fi
    w_call dotnet20
...
load_vc2010express()
{
    if w_workaround_wine_bug 32654 "Installing windows codecs to work around startup crash"
    then
        w_call windowscodecs
    fi
    if w_workaround_wine_bug 32280 "Replacing mono with dotnet40 to avoid fatal 'Unknown Error'"
    then
        # "w_call remove_mono" might suffice
        w_call dotnet40
    fi
    ...
    w_declare_exe "$W_PROGRAMS_X86_WIN\\Microsoft Visual Studio 10.0\\Common7\\IDE" "VCExpress.exe"
}
...
load_3dmark06()
{
    ...
    then
        w_warn "The benchmark may warn that shader model 2.0 is not present.  You can ignore this, but if you want to work around it, see http://bugs.winehq.org/show_bug.cgi?id=9210 for a patch."
    fi
...
load_acreedbro()
{
    ...
    then
        ...
        then
            ...
            mymenu="$XDG_DATA_HOME/applications/wine/Programs/Ubisoft/Assassin's Creed Brotherhood/Assassin's Creed Brotherhood.desktop"
            if test -f "$mymenu"
            then
                sed -i "s,Exec=.*,$myexec," "$mymenu"
            fi
...
load_hon()
{
    ...
    "
    if w_workaround_wine_bug 25919 "disabling mmdevapi to fix sound and avoid crash"
    then
...
load_masseffect2_demo()
{
    ...
    then
        ...
        then
            ...
            myexec="Exec=env WINEPREFIX=\"$XDG_DATA_HOME/wineprefixes/masseffect2_demo\" wine-hotfix-6971 cmd /c 'C:\\\\\\Run-masseffect2_demo.bat'"
            ...
            mymenu="$XDG_DATA_HOME/applications/wine/Programs/Mass Effect 2 Demo/Mass Effect 2 Demo.desktop"
            if test -f "$mymenu"
            then
                # this is a hack, hopefully the wine bug will be fixed soon
                sed -i "s,Exec=.*,$myexec," "$mymenu"
        ...
        w_workaround_wine_bug 6971 "Please upgrade to wine-1.3.23 or later; see http://wiki.winehq.org/Bug6971" 1.3.23, || true
    fi
...
load_nfsworld()
{
    w_workaround_wine_bug 27048 "The patcher will probably put up an error dialog and then hang.  When this happens, kill it and try again.  It should succeed after the fourth or so try."
    ...
    w_download http://static.cdn.ea.com/blackbox/u/f/NFSWO/1509/launcher/weblaunch_1.8.40.1509/setup_nfsw.exe 6f76c74ae07d36470931bac74b44548d1a319ce0

    # pre-1.6 versions of wine also needed ie7?
    if w_workaround_wine_bug 25658 "Installing dotnet20 so launcher does not just exit"
    then
        w_call dotnet20
    fi

    if w_workaround_wine_bug 28652 "Installing gdiplus so launcher does not look horrible (and to work around crash bug 33880, too)"
    then
        w_call gdiplus
    fi

    if test "$W_OPT_UNATTENDED" && w_workaround_wine_bug 25961 "Installing vcrun2008 just to make unattended install easier"
    then
        w_call vcrun2008
    fi
...
load_qq2012()
{
    w_download http://dl_dir.qq.com/qqfile/qq/QQ2012/QQ2012.exe ea20cd09390588ea0943e0d0f9af56544a4cac4f
    cd "$W_CACHE/$W_PACKAGE"
...
load_qqintl()
{
    w_download http://proxy.imqq.com/QQIntl2.0.exe e9a335b265544a77ae470d6f3a3fca0de25a6cb5
    cd "$W_CACHE/$W_PACKAGE"
...
load_simsmed()
{
    ...
    then
        myexec="Exec=env WINEPREFIX=\"$WINEPREFIX\" wine cmd /c 'C:\\\\\\\\Run-$W_PACKAGE.bat'"
        mymenu="$XDG_DATA_HOME/applications/wine/Programs/Electronic Arts/The Sims Medieval/The Simsâ„¢ Medieval.desktop"
        if test -f "$mymenu"
        then
            sed -i "s,Exec=.*,$myexec," "$mymenu"
        fi
        mymenu="$HOME/Desktop/The Simsâ„¢ Medieval.desktop"
        if test -f "$mymenu"
        then
            sed -i "s,Exec=.*,$myexec," "$mymenu"
        fi
...
w_metadata glsl=enabled settings \
    title_uk="Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚Ð¸ glsl ÑˆÐµÐ¹Ð´ÐµÑ€Ð¸ (Ð·Ð° Ð·Ð°Ð¼Ð¾Ð²Ñ‡ÑƒÐ²Ð°Ð½Ð½ÑÐ¼)" \
    title="Enable glsl shaders (default)"
w_metadata glsl=disabled settings \
    title_uk="Ð’Ð¸Ð¼ÐºÐ½ÑƒÑ‚Ð¸ glsl ÑˆÐµÐ¹Ð´ÐµÑ€Ð¸ Ñ‚Ð° Ð²Ð¸ÐºÐ¾Ñ€Ð¸ÑÑ‚Ð¾Ð²ÑƒÐ²Ð°Ñ‚Ð¸ arb ÑˆÐµÐ¹Ð´ÐµÑ€Ð¸ (ÑˆÐ²Ð¸Ð´ÑˆÐµ, Ð°Ð»Ðµ Ñ–Ð½Ð¾Ð´Ñ– Ð· Ð¿ÐµÑ€ÐµÑ€Ð²Ð°Ð¼Ð¸)" \
...
w_metadata multisampling=enabled settings \
    title_uk="Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚Ð¸ Direct3D Ð¼ÑƒÐ»ÑŒÑ‚Ð¸ÑÐµÐ¼Ð¿Ð»Ñ–Ð½Ð³" \
    title="Enable Direct3D multisampling"
w_metadata multisampling=disabled settings \
    title_uk="Ð’Ð¸Ð¼ÐºÐ½ÑƒÑ‚Ð¸ Direct3D Ð¼ÑƒÐ»ÑŒÑ‚Ð¸ÑÐµÐ¼Ð¿Ð»Ñ–Ð½Ð³" \
...
w_metadata npm=repack settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ NonPower2Mode Ð½Ð° repack" \
...
w_metadata orm=fbo settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ OffscreenRenderingMode=fbo (Ð·Ð° Ð·Ð°Ð¼Ð¾Ð²Ñ‡ÑƒÐ²Ð°Ð½Ð½ÑÐ¼)" \
    title="Set OffscreenRenderingMode=fbo (default)"
w_metadata orm=backbuffer settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ OffscreenRenderingMode=backbuffer" \
...
w_metadata psm=enabled settings \
    title_uk="Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚Ð¸ PixelShaderMode" \
    title="Set PixelShaderMode to enabled"
w_metadata psm=disabled settings \
    title_uk="Ð’Ð¸Ð¼ÐºÐ½ÑƒÑ‚Ð¸ PixelShaderMode" \
...
w_metadata strictdrawordering=enabled settings \
    title_uk="Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚Ð¸ StrictDrawOrdering" \
    title="Enable StrictDrawOrdering"
w_metadata strictdrawordering=disabled settings \
    title_uk="Ð’Ð¸Ð¼ÐºÐ½ÑƒÑ‚Ð¸ StrictDrawOrdering (Ð·Ð° Ð·Ð°Ð¼Ð¾Ð²Ñ‡ÑƒÐ²Ð°Ð½Ð½ÑÐ¼)" \
...
w_metadata ao=enabled settings \
    title_uk="Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚Ð¸ AlwaysOffscreen" \
    title="Enable AlwaysOffscreen"
w_metadata ao=disabled settings \
    title_uk="Ð’Ð¸Ð¼ÐºÐ½ÑƒÑ‚Ð¸ AlwaysOffscreen (Ð·Ð° Ð·Ð°Ð¼Ð¾Ð²Ñ‡ÑƒÐ²Ð°Ð½Ð½ÑÐ¼)" \
...
w_metadata ddr=gdi settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ DirectDrawRenderer Ð½Ð° gdi" \
    title="Set DirectDrawRenderer to gdi"
w_metadata ddr=opengl settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ DirectDrawRenderer Ð½Ð° opengl" \
...
w_metadata mwo=force settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ð¿Ñ€Ð¸Ð¼ÑƒÑÐ¾Ð²Ðµ DirectInput MouseWarpOverride (Ð½ÐµÐ¾Ð±Ñ…Ñ–Ð´Ð½Ð¾ Ð´Ð»Ñ Ð´ÐµÑÐºÐ¸Ñ… Ñ–Ð³Ð¾Ñ€)" \
    title="Set DirectInput MouseWarpOverride to force (needed by some games)"
w_metadata mwo=enabled settings \
    title_uk="Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚Ð¸ DirectInput MouseWarpOverride (Ð·Ð° Ð·Ð°Ð¼Ð¾Ð²Ñ‡ÑƒÐ²Ð°Ð½Ð½ÑÐ¼)" \
    title="Set DirectInput MouseWarpOverride to enabled (default)"
w_metadata mwo=disable settings \
    title_uk="Ð’Ð¸Ð¼ÐºÐ½ÑƒÑ‚Ð¸ DirectInput MouseWarpOverride" \
...
w_metadata macdriver=mac settings \
    title_uk="Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚Ð¸ Ñ€Ñ–Ð´Ð½Ð¸Ð¹ Mac Quartz Ð´Ñ€Ð°Ð¹Ð²ÐµÑ€ (Ð·Ð° Ð·Ð°Ð¼Ð¾Ð²Ñ‡ÑƒÐ²Ð°Ð½Ð½ÑÐ¼)" \
    title="Enable the Mac native Quartz driver (default)"
w_metadata macdriver=x11 settings \
    title_uk="Ð’Ð¸Ð¼ÐºÐ½ÑƒÑ‚Ð¸ Ñ€Ñ–Ð´Ð½Ð¸Ð¹ Mac Quartz Ð´Ñ€Ð°Ð¹Ð²ÐµÑ€ Ñ‚Ð° Ð²Ð¸ÐºÐ¾Ñ€Ð¸ÑÑ‚Ð¾Ð²ÑƒÐ²Ð°Ñ‚Ð¸ Ð·Ð°Ð¼Ñ–ÑÑ‚ÑŒ Ð½ÑŒÐ¾Ð³Ð¾ X11" \
...
w_metadata grabfullscreen=y settings \
    title_uk="ÐŸÑ€Ð¸Ð¼ÑƒÑÐ¾Ð²Ðµ Ð·Ð°Ñ…Ð¾Ð¿Ð»ÐµÐ½Ð½Ñ ÐºÑƒÑ€ÑÐ¾Ñ€Ñƒ Ð´Ð»Ñ Ð¿Ð¾Ð²Ð½Ð¾ÐµÐºÑ€Ð°Ð½Ð½Ð¸Ñ… Ð²Ñ–ÐºÐ¾Ð½ (Ð½ÐµÐ¾Ð±Ñ…Ñ–Ð´Ð½Ð¾ Ð´Ð»Ñ Ð´ÐµÑÐºÐ¸Ñ… Ñ–Ð³Ð¾Ñ€)" \
    title="Force cursor clipping for full-screen windows (needed by some games)"
w_metadata grabfullscreen=n settings \
    title_uk="Ð’Ð¸Ð¼ÐºÐ½ÑƒÑ‚Ð¸ Ð¿Ñ€Ð¸Ð¼ÑƒÑÐ¾Ð²Ðµ Ð·Ð°Ñ…Ð¾Ð¿Ð»ÐµÐ½Ð½Ñ ÐºÑƒÑ€ÑÐ¾Ñ€Ñƒ Ð´Ð»Ñ Ð¿Ð¾Ð²Ð½Ð¾ÐµÐºÑ€Ð°Ð½Ð½Ð¸Ñ… Ð²Ñ–ÐºÐ¾Ð½ (Ð·Ð° Ð·Ð°Ð¼Ð¾Ð²Ñ‡ÑƒÐ²Ð°Ð½Ð½ÑÐ¼)" \
...
w_metadata windowmanagerdecorated=y settings \
    title_uk="Ð”Ð¾Ð·Ð²Ð¾Ð»Ð¸Ñ‚Ð¸ Ð¼ÐµÐ½ÐµÐ´Ð¶ÐµÑ€Ñƒ Ð²Ñ–ÐºÐ¾Ð½ Ð´ÐµÐºÐ¾Ñ€ÑƒÐ²Ð°Ñ‚Ð¸ Ð²Ñ–ÐºÐ½Ð° (Ð·Ð° Ð·Ð°Ð¼Ð¾Ð²Ñ‡ÑƒÐ²Ð°Ð½Ð½ÑÐ¼)" \
    title="Allow the window manager to decorate windows (default)"
w_metadata windowmanagerdecorated=n settings \
    title_uk="ÐÐµ Ð´Ð¾Ð·Ð²Ð¾Ð»ÑÑ‚Ð¸ Ð¼ÐµÐ½ÐµÐ´Ð¶ÐµÑ€Ñƒ Ð²Ñ–ÐºÐ¾Ð½ Ð´ÐµÐºÐ¾Ñ€ÑƒÐ²Ð°Ñ‚Ð¸ Ð²Ñ–ÐºÐ½Ð°" \
...
w_metadata windowmanagermanaged=y settings \
    title_uk="Ð”Ð¾Ð·Ð²Ð¾Ð»Ð¸Ñ‚Ð¸ Ð¼ÐµÐ½ÐµÐ´Ð¶ÐµÑ€Ñƒ Ð²Ñ–ÐºÐ¾Ð½ ÐºÐµÑ€ÑƒÐ²Ð°Ð½Ð½Ñ Ð²Ñ–ÐºÐ½Ð°Ð¼Ð¸ (Ð·Ð° Ð·Ð°Ð¼Ð¾Ð²Ñ‡ÑƒÐ²Ð°Ð½Ð½ÑÐ¼)" \
    title="Allow the window manager to control windows (default)"
w_metadata windowmanagermanaged=n settings \
    title_uk="ÐÐµ Ð´Ð¾Ð·Ð²Ð¾Ð»ÑÑ‚Ð¸ Ð¼ÐµÐ½ÐµÐ´Ð¶ÐµÑ€Ñƒ Ð²Ñ–ÐºÐ¾Ð½ ÐºÐµÑ€ÑƒÐ²Ð°Ð½Ð½Ñ Ð²Ñ–ÐºÐ½Ð°Ð¼Ð¸" \
...
w_metadata alldlls=default settings \
    title_uk="Ð’Ð¸Ð´Ð°Ð»Ð¸Ñ‚Ð¸ Ð²ÑÑ– Ð¿ÐµÑ€ÐµÐ²Ð¸Ð·Ð½Ð°Ñ‡ÐµÐ½Ð½Ñ DLL" \
    title="Remove all DLL overrides"
w_metadata alldlls=builtin settings \
    title_uk="ÐŸÐµÑ€ÐµÐ²Ð¸Ð·Ð½Ð°Ñ‡Ð¸Ñ‚Ð¸ Ð½Ð°Ð¹Ð±Ñ–Ð»ÑŒÑˆ Ð¿Ð¾ÑˆÐ¸Ñ€ÐµÐ½Ñ– DLL Ð½Ð° Ð²Ð±ÑƒÐ´Ð¾Ð²Ð°Ð½Ñ–" \
...
w_metadata fontsmooth=disable settings \
    title_uk="Ð’Ð¸Ð¼ÐºÐ½ÑƒÑ‚Ð¸ Ð·Ð³Ð»Ð°Ð´Ð¶ÑƒÐ²Ð°Ð½Ð½Ñ ÑˆÑ€Ð¸Ñ„Ñ‚Ñƒ" \
    title="Disable font smoothing"
w_metadata fontsmooth=bgr settings \
    title_uk="Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚Ð¸ ÑÑƒÐ±Ð¿Ñ–ÐºÑÐµÐ»ÑŒÐ½Ðµ Ð·Ð³Ð»Ð°Ð´Ð¶ÑƒÐ²Ð°Ð½Ð½Ñ ÑˆÑ€Ð¸Ñ„Ñ‚Ñƒ Ð´Ð»Ñ BGR LCD Ð¼Ð¾Ð½Ñ–Ñ‚Ð¾Ñ€Ñ–Ð²" \
    title="Enable subpixel font smoothing for BGR LCDs"
w_metadata fontsmooth=rgb settings \
    title_uk="Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚Ð¸ ÑÑƒÐ±Ð¿Ñ–ÐºÑÐµÐ»ÑŒÐ½Ðµ Ð·Ð³Ð»Ð°Ð´Ð¶ÑƒÐ²Ð°Ð½Ð½Ñ ÑˆÑ€Ð¸Ñ„Ñ‚Ñƒ Ð´Ð»Ñ RGB LCD Ð¼Ð¾Ð½Ñ–Ñ‚Ð¾Ñ€Ñ–Ð²" \
    title="Enable subpixel font smoothing for RGB LCDs"
w_metadata fontsmooth=gray settings \
    title_uk="Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚Ð¸ ÑÑƒÐ±Ð¿Ñ–ÐºÑÐµÐ»ÑŒÐ½Ðµ Ð·Ð³Ð»Ð°Ð´Ð¶ÑƒÐ²Ð°Ð½Ð½Ñ ÑˆÑ€Ð¸Ñ„Ñ‚Ñƒ" \
...
w_metadata forcemono settings \
    title_uk="ÐŸÑ€Ð¸Ð¼ÑƒÑÐ¾Ð²Ðµ Ð²Ð¸ÐºÐ¾Ñ€Ð¸ÑÑ‚Ð°Ð½Ð½Ñ mono Ð·Ð°Ð¼Ñ–ÑÑ‚ÑŒ .Net (Ð´Ð»Ñ Ð½Ð°Ð»Ð¾Ð³Ð¾Ð´Ð¶ÐµÐ½Ð½Ñ)" \
...
w_metadata heapcheck settings \
    title_uk="Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚Ð¸ Ð½Ð°ÐºÐ¾Ð¿Ð¸Ñ‡ÑƒÐ²Ð°Ð»ÑŒÐ½Ñƒ Ð¿ÐµÑ€ÐµÐ²Ñ–Ñ€ÐºÑƒ GlobalFlag" \
...
w_metadata hosts settings \
    title_uk="Ð”Ð¾Ð´Ð°Ñ‚Ð¸ Ð¿Ð¾Ñ€Ð¾Ð¶Ð½Ñ– Ñ„Ð°Ð¹Ð»Ð¸ Ñƒ C:\windows\system32\drivers\etc\{hosts,services}" \
...
w_metadata native_mdac settings \
    title_uk="ÐŸÐµÑ€ÐµÐ²Ð¸Ð·Ð½Ð°Ñ‡Ð¸Ñ‚Ð¸ odbc32, odbccp32 Ñ‚Ð° oledb32" \
...
w_metadata native_oleaut32 settings \
    title_uk="ÐŸÐµÑ€ÐµÐ²Ð¸Ð·Ð½Ð°Ñ‡Ð¸Ñ‚Ð¸ oleaut32" \
...
w_metadata nocrashdialog settings \
    title_uk="Ð’Ð¸Ð¼ÐºÐ½ÑƒÑ‚Ð¸ Ð´Ñ–Ð°Ð»Ð¾Ð³ Ð¿Ñ€Ð¾ Ð¿Ð¾Ð¼Ð¸Ð»ÐºÑƒ" \
...
w_metadata nt40 settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ð²ÐµÑ€ÑÑ–ÑŽ Windows NT 4.0" \
...
w_metadata sandbox settings \
    title_uk="ÐŸÑ–ÑÐ¾Ñ‡Ð½Ð¸Ñ†Ñ wineprefix - Ð²Ð¸Ð´Ð°Ð»Ð¸Ñ‚Ð¸ Ð¿Ð¾ÑÐ¸Ð»Ð°Ð½Ð½Ñ Ð´Ð¾ HOME" \
...
w_metadata sound=alsa settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ð·Ð²ÑƒÐºÐ¾Ð²Ð¸Ð¹ Ð´Ñ€Ð°Ð¹Ð²ÐµÑ€ ALSA" \
    title="Set sound driver to ALSA"
w_metadata sound=coreaudio settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ð·Ð²ÑƒÐºÐ¾Ð²Ð¸Ð¹ Ð´Ñ€Ð°Ð¹Ð²ÐµÑ€ Mac CoreAudio" \
    title="Set sound driver to Mac CoreAudio"
w_metadata sound=disabled settings \
    title_uk="Ð’Ð¸Ð¼ÐºÐ½ÑƒÑ‚Ð¸ Ð·Ð²ÑƒÐºÐ¾Ð²Ð¸Ð¹ Ð´Ñ€Ð°Ð¹Ð²ÐµÑ€" \
    title="Set sound driver to disabled"
w_metadata sound=oss settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ð·Ð²ÑƒÐºÐ¾Ð²Ð¸Ð¹ Ð´Ñ€Ð°Ð¹Ð²ÐµÑ€ OSS" \
...
w_metadata vd=off settings \
    title_uk="Ð’Ð¸Ð¼ÐºÐ½ÑƒÑ‚Ð¸ Ð²Ñ–Ñ€Ñ‚ÑƒÐ°Ð»ÑŒÐ½Ð¸Ð¹ Ñ€Ð¾Ð±Ð¾Ñ‡Ð¸Ð¹ ÑÑ‚Ñ–Ð»" \
    title="Disable virtual desktop"
w_metadata vd=640x480 settings \
    title_uk="Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚Ð¸ Ð²Ñ–Ñ€Ñ‚ÑƒÐ°Ð»ÑŒÐ½Ð¸Ð¹ Ñ€Ð¾Ð±Ð¾Ñ‡Ð¸Ð¹ ÑÑ‚Ñ–Ð» Ñ‚Ð° Ð¿Ð¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ñ€Ð¾Ð·Ð¼Ñ–Ñ€ 640x480" \
    title="Enable virtual desktop, set size to 640x480"
w_metadata vd=800x600 settings \
    title_uk="Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚Ð¸ Ð²Ñ–Ñ€Ñ‚ÑƒÐ°Ð»ÑŒÐ½Ð¸Ð¹ Ñ€Ð¾Ð±Ð¾Ñ‡Ð¸Ð¹ ÑÑ‚Ñ–Ð» Ñ‚Ð° Ð¿Ð¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ñ€Ð¾Ð·Ð¼Ñ–Ñ€ 800x600" \
    title="Enable virtual desktop, set size to 800x600"
w_metadata vd=1024x768 settings \
    title_uk="Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚Ð¸ Ð²Ñ–Ñ€Ñ‚ÑƒÐ°Ð»ÑŒÐ½Ð¸Ð¹ Ñ€Ð¾Ð±Ð¾Ñ‡Ð¸Ð¹ ÑÑ‚Ñ–Ð» Ñ‚Ð° Ð¿Ð¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ñ€Ð¾Ð·Ð¼Ñ–Ñ€ 1024x768" \
    title="Enable virtual desktop, set size to 1024x768"
w_metadata vd=1280x1024 settings \
    title_uk="Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚Ð¸ Ð²Ñ–Ñ€Ñ‚ÑƒÐ°Ð»ÑŒÐ½Ð¸Ð¹ Ñ€Ð¾Ð±Ð¾Ñ‡Ð¸Ð¹ ÑÑ‚Ñ–Ð» Ñ‚Ð° Ð¿Ð¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ñ€Ð¾Ð·Ð¼Ñ–Ñ€ 1280x1024" \
    title="Enable virtual desktop, set size to 1280x1024"
w_metadata vd=1440x900 settings \
    title_uk="Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚Ð¸ Ð²Ñ–Ñ€Ñ‚ÑƒÐ°Ð»ÑŒÐ½Ð¸Ð¹ Ñ€Ð¾Ð±Ð¾Ñ‡Ð¸Ð¹ ÑÑ‚Ñ–Ð» Ñ‚Ð° Ð¿Ð¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ñ€Ð¾Ð·Ð¼Ñ–Ñ€ 1440x900" \
...
w_metadata videomemorysize=default settings \
    title_uk="Ð”Ð°Ñ‚Ð¸ Ð¼Ð¾Ð¶Ð»Ð¸Ð²Ñ–ÑÑ‚ÑŒ Wine Ð²Ð¸Ð·Ð½Ð°Ñ‡Ð¸Ñ‚Ð¸ Ñ€Ð¾Ð·Ð¼Ñ–Ñ€ Ð²Ñ–Ð´ÐµÐ¾Ð¿Ð°Ð¼'ÑÑ‚Ñ–" \
    title="Let Wine detect amount of video card memory"
w_metadata videomemorysize=512 settings \
    title_uk="ÐŸÐ¾Ð²Ñ–Ð´Ð¾Ð¼Ð¸Ñ‚Ð¸ Wine Ð¿Ñ€Ð¾ 512ÐœÐ‘ Ð²Ñ–Ð´ÐµÐ¾Ð¿Ð°Ð¼'ÑÑ‚Ñ–" \
    title="Tell Wine your video card has 512MB RAM"
w_metadata videomemorysize=1024 settings \
    title_uk="ÐŸÐ¾Ð²Ñ–Ð´Ð¾Ð¼Ð¸Ñ‚Ð¸ Wine Ð¿Ñ€Ð¾ 1024ÐœÐ‘ Ð²Ñ–Ð´ÐµÐ¾Ð¿Ð°Ð¼'ÑÑ‚Ñ–" \
    title="Tell Wine your video card has 1024MB RAM"
w_metadata videomemorysize=2048 settings \
    title_uk="ÐŸÐ¾Ð²Ñ–Ð´Ð¾Ð¼Ð¸Ñ‚Ð¸ Wine Ð¿Ñ€Ð¾ 2048ÐœÐ‘ Ð²Ñ–Ð´ÐµÐ¾Ð¿Ð°Ð¼'ÑÑ‚Ñ–" \
...
w_metadata vista settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ð²ÐµÑ€ÑÑ–ÑŽ Windows Vista" \
...
w_metadata vsm=hardware settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ VertexShaderMode Ð½Ð° hardware" \
...
w_metadata win2k settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ð²ÐµÑ€ÑÑ–ÑŽ Windows 2000" \
...
w_metadata win2k3 settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ð²ÐµÑ€ÑÑ–ÑŽ Windows 2003" \
...
w_metadata win31 settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ð²ÐµÑ€ÑÑ–ÑŽ Windows 3.1" \
...
w_metadata win7 settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ð²ÐµÑ€ÑÑ–ÑŽ Windows 7" \
...
w_metadata win95 settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ð²ÐµÑ€ÑÑ–ÑŽ Windows 95" \
...
w_metadata win98 settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ð²ÐµÑ€ÑÑ–ÑŽ Windows 98" \
...
w_metadata winver= settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ð²ÐµÑ€ÑÑ–ÑŽ Windows Ð·Ð° Ð·Ð°Ð¼Ð¾Ð²Ñ‡ÑƒÐ²Ð°Ð½Ð½ÑÐ¼ (winxp)" \
...
w_metadata winxp settings \
    title_uk="ÐŸÐ¾ÑÑ‚Ð°Ð²Ð¸Ñ‚Ð¸ Ð²ÐµÑ€ÑÑ–ÑŽ Windows XP" \
